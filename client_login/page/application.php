      ...
      $k=0;
                        ...
                        while ( $row = mysqli_fetch_assoc($query_result) ) {
                            ...
                            <div class="recent-job-list"><!-- Tabs content -->
                                ...
                                <div class="col-md-4 job-list-location">
                                  <h6> <i class="fa fa-users"></i>
                                  <a href="candidate_list.php?id='.$row["post_id"].'" >Pending ('.$ob_sup_admin->get_number_of_candidate($row["post_id"]).')</a>,<a href="accepted_list.php?id='.$row["post_id"].'" > Accepted('.$ob_sup_admin->get_number_of_accepted_candidate($row["post_id"]).'),</a> <a href="canceled_list.php?id='.$row["post_id"].'" >Canceled('.$ob_sup_admin->get_number_of_canceled_candidate($row["post_id"]).') </a></h6>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-7 job-list-type">
                                         <a class=" btn-apply-job" href="response.php?id='.$row["post_id"].'" >Invite Selected </a>
                                    </div>
