    ...
    <div class="container">        
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required name="vacancies" id="vacancies" class="form-control" placeholder="No. of vacancies">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="date" required name="apply_dateline" id="apply_dateline"  class="form-control" placeholder="Application Deadline">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" required name="edu_req" id="edu_req"  class="form-control" placeholder="Educational requirement">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text"  name="additional_req" id="additional_req"  class="form-control" placeholder="Additional requirement">
                </td>
            </tr>
             ...
             <td style="text-align:left;"><br>Year of experience<span style="color: red;"> *</span> <br><br> Experience in area/position<br><br> Experience in industry
                            ...
                            <td>
                                <select class="form-control" name="ex_year" id="" class="form-control">
                                 ...
                                 <br>
                                <input type="text"  name="ex_area" id="apply_dateline"  class="form-control" placeholder="Do you need the candidate to have experience in any specific area or position?">
                                <br>
                                <input type="text"  name="ex_industry" id="apply_dateline" class="form-control"  placeholder="Do you need the candidate to have experience in any specific industries?">
                            </td>
