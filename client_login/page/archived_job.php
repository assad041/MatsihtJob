<?php
    ...
    $all=0;
    $query_result=$ob_sup_admin->select_all_archived_job($_SESSION['client_id']);
...
?>
    <div class="recent-job"><!-- Start Job -->
            <div class="container">
                <h4><i class="fa fa-briefcase"></i> Archive Job</h4>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 job-list-button">
                                            <a href="../view_job.php?id='.$row["post_id"].'&&page=archived" class="btn-view-job" >View Job</a>
                                        </div>
                                    </div>
                                </div>
