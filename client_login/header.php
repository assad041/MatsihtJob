<!--
 * Created by Assaduzzaman Noor(0168277666) on 9/11/2016.
 */-->
<!DOCTYPE html>
<html lang="en">
  <head>
						...
						<nav>
							<ul class="menu">
								<li><a  href="index.php">Dashboard <span class="fa fa-caret-down"></span> </a>
                                                                ...
                                                                <li><a  href="job_post.php"> Job Post</a></li>
								                                <li><a  href="posted_job.php">Posted Job</a></li>
								                                <li><a  href="drafted_job.php">Drafted Job</a></li>
								                                <li><a  href="archived_job.php">Archived Job</a></li>
