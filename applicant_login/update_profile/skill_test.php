    ...
    */
    if(isset($_GET['status'])) {
        ...
        if($_GET['status'] == 'delete') {
            $message=$ob_sup_admin->delete_academics($org_id);
        }
}
...
<div class="main-page-title" style="background-color:white;"><!-- start main page title -->
    <div class="container">        
        <div class="row">
            <div class="col-md-9">
                <br>
               <pre style="color:green;font-weight:bold;font-size:15px;text-align:left;">Select Category</pre>
                    ...
                    <table style="font-size:12px;" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;">Comments</th> <td style='text-align:left;'>".$academic_info["institute_university"]."</td><td style='text-align:center;'>".$academic_info["passing_year"]."</td><td style='text-align:center;'>".$academic_info["result"]."</td><td style='text-align:left;'>".$academic_info["comments"]."</td>-->
                        ...
                        <?php
                            ...
                            while ($academic_info=mysqli_fetch_assoc($query_result)) {
                                ...
                                echo "<tr><td style='text-align:left;'>".$ob_sup_admin->get_category_by_id($academic_info["degree_name"])."</td><td><a href='?status=delete&&id=".$academic_info["aca_id"]."' > <span class='fa fa-trash-o' style='color:red'></span>Delete</a> </td></tr>";
                                if(empty($academic_info["result"])){
                                	
                                }
                                else if(0)
                                	echo "
                                	<a href='?status=edit&&id=".$academic_info["aca_id"]."' class=''><span class='fa fa-edit'></span> Retake</a>";
                        ...
                        <?php if($it==1) { ?>
                            <tr>
                                ...
                                <input name="institute_university" required placeholder="Matsith" readonly type="hidden" class="form-control">
                                <input name="passing_year" required placeholder="Passing Year" readonly type="hidden" class="form-control">
                                <input name="result" required placeholder="Result (Out of 5)" readonly type="hidden" class="form-control">
                                <input name="comments"  placeholder="Comments" type="hidden" value="" readonly class="form-control">
                            ...
                            <tr>
                               ...
                               <td><input name="institute_university" required placeholder="Matsith" value="<?=$aca_info["institute_university"]?>" readonly type="text" class="form-control"></td>
                                ...
                                <td><input name="comments"  placeholder="Apply for retake" type="text" value="1" readonly class="form-control"></td>
