                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-7 job-list-type">';
                                            if($row["inbox"]==0)
                                               echo ' <h6 ><i class="fa fa-envelope"style="color:gray"></i>Inbox</h6>';
                                           else if($row["new"]==1)
                                               echo '<a href="inbox.php?id='.$row["inbox"].'&&apply_id='.$row["apply_id"].'"><h6><i class="fa fa-envelope"></i>Inbox (1)</h6></a>';
                                           else 
                                               echo '<a href="inbox.php?id='.$row["inbox"].'&&apply_id='.$row["apply_id"].'"><h6><i class="fa fa-envelope"></i>Inbox</h6></a>';
                                             echo '
                                        </div>
