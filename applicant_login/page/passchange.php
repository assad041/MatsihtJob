...
if(isset($_POST['btn'])) {
      $message=$ob_sup_admin->change_applicant_pass($_POST);
}

$info=$ob_sup_admin->select_applicant_by_id($_SESSION['applicant_id']);
            ...
            <div class="col-md-9">
                ...
                <form method='POST' action='#'>
                    ...
                    <table class='table table-bordered table-striped table-hover'>
                        <tr><td style='text-align:left;'>Email</td><td style='text-align:left;'><?=$info["email"]?></td></tr>
                        <tr><td style='text-align:left;'>Billing Email</td><td style='text-align:left;'><?=$info["cell_phone"]?></td></tr>
