<?php
    ...
    session_start();
    $message="";
    $admin_id=  isset($_SESSION['applicant_id']);
    if($admin_id) {
    ...
    if(isset($_POST['log'])) {
        ...
        $message=$obj_admin->applicant_login_check($_POST);
        echo '<script>window.setTimeout(function(){ window.location = "index.php"; },1000);</script>';
    }

    if(isset($_POST['forgot'])) {

        $message=$obj_admin->forgot_applicant_acount($_POST);
...
<div class="main-page-title"><!-- start main page title -->
            ...
            <div class="container">
                ...
                <h4 class="login-title">Candidate Log In</h4>
                <div class="row">
                    <div class="col-md-5">
                     <h6 align="center"><?=$message?></h6>
                      ...
                      <div class="form-group">
                            <input type="email" name='email' class="form-control input-form" placeholder="Email Address">
                            <div class="register-aksen"></div>
                        </div>
                        <div class="form-group">
                            <input type="password" name='password' class="form-control input-form" placeholder="Password">
                            <div class="register-aksen"></div>
                            <button class="btn btn-default btn-green" name="log" value=" "><span class="fa fa-sign-in"></span> LOGIN</button>
                    ...
                    <div class="col-md-7 singin-page">
                       <h5>Not A Candidate?</h5>
                <p>If you don`t have an account please register now</p>
                        <a href="../candidate_register.php" class="btn btn-default btn-blue">REGISTER</a>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            while ($f_info=mysqli_fetch_assoc($query_result1)) {
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition1")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition2")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition3")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition4")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition5")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition6")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition7")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
                                if($f_info["cat_name"]=="Applicant Terms &amp; Condition8")
                                    echo '<li>'.$f_info["cat_title"].'</li>';
        ...
        /*
        echo '    <div class="recent-job"><!-- start main page title -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 singin-page">
                ...
                <a class="btn btn-default btn-green" href="../candidate_register.php">REGISTER</a>
                <div class="row">
                    <div class="col-md-12">
                        <ul class="style-list-2">
                             <?php
