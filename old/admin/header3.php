			...
			<div class="container"><!-- container -->
				<div class="row">
					...
					<div class="col-md-10 main-nav"><!-- Main Navigation -->
						...
						<nav>
							<ul class="menu">
								<li><a  href="admin/index.php">Dashboard <span class="fa fa-caret-down"></span> </a>
                                                                    <ul class='sub-menu'>
                                                                        <li><a  href="admin/passchange.php"><span class="fa fa-edit"></span> Password Change</a></li>
                                                                        <li><a  href="?status=logout"><span class="fa fa-sign-out"></span> Logout</a></li>
                                                                    </ul>
                                                                </li>
                                                                
                                                                <li><a  href="admin/job_publish.php"> Job Published</a></li>                                                                
								<li><a  href="admin/verify.php"> Candidate Verify (<span style="color:red"><?=$allv?></span>)</a></li>
								<li><a  href="admin/pandding.php"> Pending List (<span style="color:red"><?=$allp?></span>)</a></li>
								<li><a  href="admin/watting_list.php"> Waiting List (<span style="color:red"><?=$allw?></span>)</a></li>
