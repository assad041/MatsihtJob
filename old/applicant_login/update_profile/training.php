                    ...
                    <table style="font-size:12px;" class="table table-bordered table-striped">
                        ...
                        <?php if($it==1) { ?>
                            <tr>
                                ...
                                <td><input name="degree_name"  required placeholder="Enter Title" type="text" class="form-control"></td>
                                <td><input name="institute_university" required placeholder="Enter Institute" type="text" class="form-control"></td>
                                <td><input name="passing_year" required placeholder="Enter address" type="text" class="form-control"></td>
                                <td><input name="result" required placeholder="Enter Duration" type="text" class="form-control"></td>
