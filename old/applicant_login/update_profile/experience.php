<?php
    ...
    $message="Professional Experinece";
    $it=1;
    if(isset($_POST['add'])) {
                    ...
                    <table style="font-size:12px;" class="table table-bordered table-striped">
                        ...
                        <tfoot>
                            <?php if($it==1) { ?>
                                ...
                                <td><input name="degree_name"  required placeholder="Organization" type="text" class="form-control"></td>
                                <td><input name="institute_university" required placeholder="Address" type="text" class="form-control"></td>
                                <td><input name="passing_year" required placeholder="Designation" type="text" class="form-control"></td>
                                <td><input name="result" required placeholder="Join Date" type="text" class="form-control"></td>
                                <td><input name="comments"  placeholder="Leave Date" type="text" class="form-control"></td>
                                <td>
                                    <input name="others" placeholder="Responsibility" class="form-control"></input>
                                </td>
