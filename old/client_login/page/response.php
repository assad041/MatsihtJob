...
Thanks a lot for your participation in the ".$job_info["interview_method"]." under ​".$app_info["org_name"]." .You will be happy to know that, based on your interview, you have been shortlisted for the applyed job.

So, you are cordially invited to attend the ".$job_info["interview_method"]." session on Day, 0th Month, Year at Location/Skype
