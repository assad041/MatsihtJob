<?php
    ...
    $query_result=$ob_sup_admin->select_apply_job_accepted_list($id,$_SESSION['client_id']);
...
?>
        ...
        <div class="recent-job"><!-- Start Job -->
            <div class="container">
                <h4><i class="fa fa-briefcase"></i> Accepted List</h4>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-12 job-list-type" align="center">
                                             <a class="btn-view-job btn-green" >&nbsp;Accepted&nbsp;</a>
