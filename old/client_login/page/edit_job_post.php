    ...
    <div class="container">        
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required name="vacancies"  id="vacancies" value='<?=$info["vacancies"]?>' class="form-control" placeholder="Vacancies">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="date" required name="apply_dateline" value='<?=$info["apply_dateline"]?>' id="apply_dateline"  class="form-control" placeholder="Application Deadlind">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" required name="edu_req" value='<?=$info["edu_req"]?>' id="apply_dateline"  class="form-control" placeholder="Educational requirment">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text"  name="additional_req" value='<?=$info["additional_req"]?>' id="apply_dateline"  class="form-control" placeholder="Additional requirment">
                </td>
            </tr>
             <tr>
             ...
             <td style="text-align:left;"><br>Year of experience<span style="color: red;"> *</span> <br><br> Experience in area/position<br><br> Experience in industry
                            ...
                            <td>
                                <select class="form-control" name="ex_year" id="" class="form-control">
                                 ...
                                 <br>
                                <input type="text"  name="ex_area" id="apply_dateline" value='<?=$info["ex_area"]?>'  class="form-control" placeholder="Area/Position">
                                <br>
                                <input type="text"  name="ex_industry" id="apply_dateline" class="form-control" value='<?=$info["ex_industry"]?>'   placeholder="Industry Name">
                            </td>
