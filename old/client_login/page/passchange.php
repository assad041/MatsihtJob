...
if(isset($_POST['btn'])) {
      $message=$ob_sup_admin->change_organization_pass($_POST);
}
            ...
            <div class="col-md-9">
                ...
                <form method='POST' action='#'>
                    ...
                    <table class='table table-bordered table-striped table-hover'>
                        <tr><td style='text-align:left;'>Email</td><td style='text-align:left;'><?=$info["billing_email"]?></td></tr>
                        <tr><td style='text-align:left;'>Billing Cell</td><td style='text-align:left;'><?=$info["billing_cell_phone"]?></td></tr>
