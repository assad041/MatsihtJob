...
if(isset($_POST['add'])) {
      $message=$ob_sup_admin->save_category($_POST,4);
}
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <?php
                             ...
                             while ( $row = mysqli_fetch_assoc($query_result) ) {
                                ...
                                <td><a href="city_action.php?status=edit&&id='.$row["cat_id"].'" > <span class="fa fa-edit"></span> Edit</a><a href="?status=delete&&id='.$row["cat_id"].'" > <span style="color:red" class="fa fa-trash"></span> Delete</a></td>
                                </tr>';
                             }
